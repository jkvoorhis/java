...
public class Ttt3 {
	...
	// Then tries to make two in a row along a row/column/diagonal that is otherwise empty.
	...
	// column, and diagonal (as applicable) containing that square to see if there
	// are two blank squares (ie checks that the marked square is the only square filled
	// in that row/column/diagonal) and returns an adjacent square, to the one with a
	// mark in it, along an otherwise empty row/column/diagonal
	public static int twoInARow(char mark) {
		// checks if the square 1 has mark in it, and if so plays an adjacent square in 
		...
		// checks if square 2 has a mark in it, and if so plays an adjacent square in 
		...
		// checks if square 3 has a mark in it, and if so plays an adjacent square in 
		// an otherwise empty row, column, diagonal
		if (board[0][2] == mark) {
		...
		// checks if square 4 has a mark in it, and if so plays an adjacent square in 
		// an otherwise empty row, column
		if (board[1][0] == mark) {
		...
		// checks if square 5 has a mark in it, and if so plays an adjacent square in 
		// an otherwise empty row, column, diagonal
		if (board[1][1] == mark) {
		...
		// checks if square 6 has a mark in it, and if so plays an adjacent square in 
		// an otherwise empty row, column
		if (board[1][2] == mark) {
		...
		// checks if square 7 has a mark in it, and if so plays an adjacent square in 
		// an otherwise empty row, column, diagonal
		if (board[2][0] == mark) {
		...
		// checks if square 8 has a mark in it, and if so plays an adjacent square in 
		// an otherwise empty row, column
		if (board[2][1] == mark) {
		...
		// checks if square 9 has a mark in it, and if so plays an adjacent square in 
		// an otherwise empty row, column, diagonal
		if (board[2][2] == mark) {
